...
val md_theme_light_secondaryContainer = Color(0xFFFFCACC) //card
...
val md_theme_light_background = Color(0xE8E2D5D0) // background paling belakang
val md_theme_light_onBackground = Color(0xFF1A1C18)
val md_theme_light_surface = Color(0xFFDBC4F0) // background tulisan taman bunga
